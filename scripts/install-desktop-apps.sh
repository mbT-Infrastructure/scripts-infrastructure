...
"${SCRIPT_DIR}/install-apps.sh" --device "$DEVICE" --apps \
    "AndroidTools Anki Ausweisapp AuthenticationModules Bruno Camera Chromium CopyQ DBeaver \
    DesktopBasics Electrum FFmpeg Fileorganizer Firefox Firmware FreeCAD IntellijIdea Java Krita \
    LibreOffice Linphone MetadataEditors MintThemes MoneroGui OCRTools PDFsam \
